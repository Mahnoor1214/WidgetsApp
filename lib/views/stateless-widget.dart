      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              "- The widget's properties cannot change after it's created.\n"
                  "- It is generally used to display static content.\n"
                  "- Useful for UI elements that do not need to change over time, such as text, images, etc.",
              style: TextStyle(fontSize: 16, height: 1.5),
            ),
            const SizedBox(height: 16),
