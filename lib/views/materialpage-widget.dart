  ...
  Widget build(BuildContext context) {
    return  Scaffold(backgroundColor: Colors.white,
      appBar: AppBar(backgroundColor: Colors.blueAccent,
        title: const Text("MaterialPageRoute Example"),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              "- Provides a material design page transition animation.\n"
                  "- It is the default route used in Flutter for screen navigation.\n"
                  "- Can be used for both pushing and popping routes in the navigation stack.",
              style: TextStyle(fontSize: 16, height: 1.5),
            ),
            const SizedBox(height: 16),
