        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "- Adds space around the widget inside its border.\n"
                    "- Useful for creating gaps and spacing between elements.\n"
                    "- Can be used with all types of widgets to adjust their position and spacing.",
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              const SizedBox(height: 16),
