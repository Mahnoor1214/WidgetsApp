  ...
  Widget build(BuildContext context) {
    return  Scaffold(backgroundColor: Colors.white,
      appBar: AppBar(backgroundColor: Colors.blueAccent,
        title: const Text("InputDecoration Widget"),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              "- Add a label to the text field.\n"
                  "- Provide a hint text inside the field.\n"
                  "- Add icons to the start or end of the input.\n"
                  "- Style the borders of the input field.\n"
                  "- Customize error messages or focus behaviors.",
              style: TextStyle(fontSize: 16, height: 1.5),
            ),
            const SizedBox(height: 16),
